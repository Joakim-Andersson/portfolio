    ...
    return (
        <div id="skills" className="skilled">
            <div className="skilled__text">
                ...
                <p>Being the creative and visual person I am, I do prefer working Frontend. I love creating user friendly experiences and seeing my work come to life. When working Backend, I strive for optimized code performance and making sure that the data is stored securely. </p>
