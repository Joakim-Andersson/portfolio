...
export default function skills() {
    return (
        <div className="skills">
            <div className="skills__backgrounds">
                {/* <App /> */}
                <section className="first__box"> <p>1</p></section>
                <section className="second__box"> <p>2</p></section>
                <section className="third__box"> <p>3</p></section>
            </div>
            <div className="skills__headers">
                ...
                <h1 className="skills__headers-text Tools">Tools & Design</h1>
